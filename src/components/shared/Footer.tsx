...
// SVG Icons inline — no depende de Font Awesome ni librerías externas
const GitHubIcon = () => (
...
const socials = [
  ...
  {
    href: 'https://www.instagram.com/g_code20/',
    label: 'Instagram',
    Icon: InstagramIcon,
  },
]
    ...
    <footer style={{
      ...
      <div className="container" style={{ padding: '64px 24px 32px' }}>
        ...
        <div style={{
          ...
          {/* Brand column — full width en mobile via inline media hack */}
      ...
      {/* Mobile responsive — sin style jsx */}
      <style>{`
